...
import LostakInterchangeLostakInterchangeDex from './lostak/interchange/lostak.interchange.dex'
...
export default { 
  ...
  LostakInterchangeLostakInterchangeDex: load(LostakInterchangeLostakInterchangeDex, 'lostak.interchange.dex'),
