...
export type DexMsgPortResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/lostak/interchange/dex/buy_order_book
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/lostak/interchange/dex/buy_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/lostak/interchange/dex/denom_trace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/lostak/interchange/dex/denom_trace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/lostak/interchange/dex/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/lostak/interchange/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/lostak/interchange/dex/sell_order_book
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/lostak/interchange/dex/sell_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
