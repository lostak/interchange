...
export const protobufPackage = "lostak.interchange.dex";
...
export interface MsgPortResponse {}
...
export const MsgPort = {
  encode(message: MsgPort, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.channel !== "") {
    ...
    if (message.orderID !== 0) {
      writer.uint32(40).int32(message.orderID);
    }
    return writer;
  },

  decode(input: Reader | Uint8Array, length?: number): MsgPort {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgPort } as MsgPort;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: MsgPort): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
  ...
  fromPartial(object: DeepPartial<MsgPort>): MsgPort {
    const message = { ...baseMsgPort } as MsgPort;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
    } else {
...
const baseMsgPortResponse: object = {};

export const MsgPortResponse = {
  encode(_: MsgPortResponse, writer: Writer = Writer.create()): Writer {
    return writer;
  },

  decode(input: Reader | Uint8Array, length?: number): MsgPortResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgPortResponse } as MsgPortResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgPortResponse {
    const message = { ...baseMsgPortResponse } as MsgPortResponse;
    return message;
  },

  toJSON(_: MsgPortResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial(_: DeepPartial<MsgPortResponse>): MsgPortResponse {
    const message = { ...baseMsgPortResponse } as MsgPortResponse;
    return message;
  },
};
...
export interface Msg {
  ...
  Port(request: MsgPort): Promise<MsgPortResponse>;
  CancelSellOrder(
...
export class MsgClientImpl implements Msg {
  ...
  Port(request: MsgPort): Promise<MsgPortResponse> {
    const data = MsgPort.encode(request).finish();
    const promise = this.rpc.request(
      "lostak.interchange.dex.Msg",
      "Port",
      data
    );
    return promise.then((data) => MsgPortResponse.decode(new Reader(data)));
  }
